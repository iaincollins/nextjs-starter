    ...
    return (
      <Layout {...this.props}>
        ...
        <p>
          ...
          especially if you want to support signing in with than one service. It
          is also difficult to decouple the same logic from a specific database. This
          project assumes a MongoDB store for user accounts.
        </p>
